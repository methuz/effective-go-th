...
`func (file *File) Read(buf []byte) (n int, err error)` นี่คือตัวอย่างการรับ Slices เข้าไปในฟังก์ชัน
...
ถ้าเราอยากเช็คแค่ว่า key นั้นมีจริงหรือเปล่า เราก็แค่ใช้ `-` เป็นตัวแปรแรก
